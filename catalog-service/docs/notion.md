...
- [SPEC-019 - CatalogItem Update and Category Assignment](https://www.notion.so/36fbd6def30d81f99d8ae6f2fbf471c1)
...
- [SPEC-019 - CatalogItem Update and Category Assignment](./specs/SPEC-019-catalog-item-update-and-category-assignment.md)
...
- SPEC-027 is a backlog item for future PostgreSQL persistence provider selection and repository adapters.
